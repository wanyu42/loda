...
elif params['model_type'] == 'ResNet18SVHN':
...
svhn_extra = datasets.SVHN('~/dataset', split='extra',transform = transform_valid, download=True)
...
trainmodel.train(params['model_type'], 'SVHN_MASKED', device, 200, data_path = resultpath, 
